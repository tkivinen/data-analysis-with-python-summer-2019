...
``git clone https://github.com/saskeli/data-analysis-with-python-summer-2019``. Then start
...
`versions.py <https://raw.githubusercontent.com/saskeli/data-analysis-with-python-summer-2019/master/versions.py>`_
